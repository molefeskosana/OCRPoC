...
@Route(value = "domainpage")
public class DomainSpecificView extends HorizontalLayout {

    public DomainSpecificView(){
    ...
    public VerticalLayout view1(VerticalLayout verticalLayout){
        ...
        Button navButton = new Button("DomainSpecificPage", event -> UI.getCurrent().navigate("tagimagepage"));
